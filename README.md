...
> 当前状态以 [第四至第六章与英文期刊小论文融合研究实施总计划](docs/计划文档/毕业论文第四至第六章与英文期刊小论文融合研究实施总计划最终版.md) 为准。计划中的工况数量不等于已完成结果；只有规范数据和独立评价均完成后，才进入论文结论。
...
| V 补充 | V004 侧向净空单因素检查 | 已完成候选计算域和残余不确定性记录 |
