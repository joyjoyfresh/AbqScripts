...
![Fig. 2 Case matrix and validation pipeline](images/fig2_case_matrix_pipeline.png)
...
![Fig. 1 Method schematic](images/fig1_method_schematic.png)
...
![Fig. 3 Joint fields, homogeneous vs layered](images/fig3_fields_homo_vs_layered.png)
...
![Fig. 4 SP-H1 non-monotonicity and peak migration](images/fig4_sp_h1_nonmonotonicity.png)
...
![Fig. 5 SP-H2 chi scaling of cover-layer corrections](images/fig5_sp_h2_chi_scaling.png)
...
![Fig. 6 CV and blind errors stratified by rv](images/fig6_cv_blind_error_by_rv.png)
...
![Fig. 7 C005 closed-loop four panels](images/fig7_c005_representative_panels.png)
...
![Fig. 8 Ten-case closed-loop metric summary](images/fig8_ten_case_metrics_summary.png)

**Fig. 8.** Closed-loop metrics of the ten C cases against the reference lines (medians over surface points). Supplementary Fig. S1 shows the crest time-history grid of all ten cases (`images/figS1_crest_timehist_grid.png`).
...
| Figures 7/8/S1 | `images/` (PNG), `scripts/` (scripts) |

## Figure file map (all figures generated, inserted above)

| Figure | File | Generator |
|---|---|---|
| Fig. 1 | `images/fig1_method_schematic.png` | `scripts/make_physics_model_figures.py` |
| Fig. 2 | `images/fig2_case_matrix_pipeline.png` | 同上 |
| Fig. 3 | `images/fig3_fields_homo_vs_layered.png` | 同上 |
| Fig. 4 | `images/fig4_sp_h1_nonmonotonicity.png` | 同上 |
| Fig. 5 | `images/fig5_sp_h2_chi_scaling.png` | 同上 |
| Fig. 6 | `images/fig6_cv_blind_error_by_rv.png` | 同上 |
| Fig. 7 | `images/fig7_c005_representative_panels.png` | `scripts/make_c_closure_figures.py` |
| Fig. 8 | `images/fig8_ten_case_metrics_summary.png` | 同上 |
| Fig. S1 | `images/figS1_crest_timehist_grid.png` | 同上 |
