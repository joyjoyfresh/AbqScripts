    ...
    for b_idx, b in enumerate(body_blocks):
        ...
        if b_type == 'H1':
            ...
            if disp_math_idx < len(disp_omath_list):
                ...
                eq_tbl.columns[0].width = Inches(2.7)
                eq_tbl.columns[1].width = Inches(0.5)
...
if __name__ == '__main__':
    default_dir = os.path.abspath(r'docs\论文材料\小论文中文初稿')
