...
def fig7_representative():
    ...
    save_fig(fig, "fig07_代表工况闭环四联图.png", "fig7_c005_representative_panels.png")
    plt.close(fig)
...
def fig8_summary():
    ...
    save_fig(fig, "fig08_十例闭环指标汇总.png", "fig8_ten_case_metrics_summary.png")
    plt.close(fig)
...
def figS1_timehist_grid():
    ...
    fig.tight_layout(rect=[0, 0, 1, 0.96])
    save_fig(fig, "figS1_crest_timehist_grid.png", "figS1_crest_timehist_grid.png")
    plt.close(fig)
