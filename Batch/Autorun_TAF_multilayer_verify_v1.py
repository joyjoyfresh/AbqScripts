...
FOLDER_PREFIX = "verify-"  # 设置目标文件夹前缀（与 double-* 区分，便于对比验证）
...
SCRIPT_SEQUENCE = [  # 定义脚本顺序配置列表
    {"path": r"C:\Users\12462\Documents\Code\AbqScripts\Modeling\Multi\VAB_oblique_TAF_multilayer_v3.py", "parameter_target": True},  # 双层验证建模脚本（对齐 double_v4），作为参数替换目标
