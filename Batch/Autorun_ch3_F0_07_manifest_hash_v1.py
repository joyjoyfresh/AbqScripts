...
DEFAULT_ROOT = os.path.join(REPO_ROOT, 'Run')
...
def _candidate_paths(manifest_path, key, manifest):
    ...
    fixed = [
        os.path.join(REPO_ROOT, 'Modeling', 'Hybrid', 'slope_frame_ssi_full_v2.py'),
        os.path.join(REPO_ROOT, 'Postprocess', 'Hybrid', 'Postprocess_All_surface_v2.py'),
        os.path.join(REPO_ROOT, 'Postprocess', 'Hybrid', 'Collect_All_results_v2.py'),
        os.path.join(REPO_ROOT, 'Postprocess', 'Hybrid', 'Plot_Hybrid_surface_v2.py'),
        os.path.join(REPO_ROOT, 'Wave', 'Impulse', 'Acceleration', 'ricker_wavelet_4Hz.txt'),
        os.path.join(REPO_ROOT, 'Modeling', 'Hybrid', 'reference_layered_psv_v1.py'),
    ]
